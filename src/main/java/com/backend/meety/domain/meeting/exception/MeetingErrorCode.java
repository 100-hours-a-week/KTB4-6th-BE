...
public enum MeetingErrorCode implements BaseCode {
    ...
    MEETING_FIELD_UPDATE_NOT_ALLOWED(HttpStatus.CONFLICT, "MEETING_FIELD_UPDATE_NOT_ALLOWED", "현재 회의 상태에서는 요청한 필드를 수정할 수 없습니다."),
    MEETING_IN_PROGRESS(HttpStatus.CONFLICT, "MEETING_IN_PROGRESS", "진행 중인 회의는 삭제할 수 없습니다."),
