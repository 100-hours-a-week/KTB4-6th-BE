...
public enum TranscriptErrorCode implements BaseCode {
    ...
    INVALID_TRANSCRIPT_KEYWORD(HttpStatus.BAD_REQUEST, "INVALID_TRANSCRIPT_KEYWORD", "전사 검색어를 확인해주세요."),
    INVALID_SPEAKER_MAPPING(HttpStatus.BAD_REQUEST, "INVALID_SPEAKER_MAPPING", "발화자 매핑 요청을 확인해주세요."),
    TRANSCRIPT_SEGMENT_NOT_FOUND(HttpStatus.NOT_FOUND, "TRANSCRIPT_SEGMENT_NOT_FOUND", "전사 세그먼트를 찾을 수 없습니다."),
